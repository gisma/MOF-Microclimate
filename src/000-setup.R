...
if (exists("setup_script") && appendProjectDirList[[1]] != "") 
{
  message("variable setup_script is NOT defined by calling script...\n '000-setup.R' is set as default\n")
  alt_env_id = "000-setup.R"
}
